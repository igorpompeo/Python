...
# Faça um programa que ajude ele, lendo o nome dos quatro alunos e escrevendo na tela o nome do escolhido.
# Exemplo: Aluno 1: Ana. Aluno 2: Bia. Aluno 3: Carlos. Aluno 4: Daniel. O aluno escolhido foi Carlos.
