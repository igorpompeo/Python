...
# Exemplo: Digite o ângulo: 30. O ângulo de 30 tem o seno de 0.5, o cosseno de 0.866 e a tangente de 0.577.
...
# angulo_rad = math.radians(angulo)  # Alternativa usando a função radians da biblioteca math
# angulo_rad = angulo * (math.pi / 180)  # Alternativa manual
angulo_rad = math.radians(angulo)  # Usando a função radians da biblioteca math
...
print(f'O ângulo de {angulo} tem o seno de {seno:.3f}, o cosseno de {cosseno:.3f} e a tangente de {tangente:.3f}.')
